...
JPanel header = createHeader("video game release"); 
...
if(buttonPressed.equals(firstButton)) {
	...
	askQuestion("what is the sixth closest planet to the sun", "saturn", 200);
	firstButton.setText(null);
	
}
//If the buttonPressed was the secondButton
if(buttonPressed.equals(secondButton)) {
askQuestion("what is the belt with small plaents within it called", "the kuiper belt", 400);
...
secondButton.setText(null);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if(correctAnswer.equalsIgnoreCase(playerAnswer)) {
			...
			JOptionPane.showMessageDialog(null, "i believe that is wrong, so HAHA");
		}
